...
newProgram:
    ...
    mov ah, 4Ah ;new size of memory
    stack_shift = program_length+100h+200h
    mov bx, stack_shift shr 4+1 ;size in paragraphs + 1
    int 21h  
...
COMMAND_LINE PROC    
      ...
      mov si, offset number   ; v si number parameter
